...
-- camHUD -> means the 'game', like the arrows, notes, time, healthbar, etc.
-- camgame -> means the background, like the bf, gf, dad, bg, and anything else [sick, animations, else]
