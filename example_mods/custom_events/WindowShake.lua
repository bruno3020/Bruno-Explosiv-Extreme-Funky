...
function onEvent(name, value_1, value_2)
    local events = {
        ["WindowShake"] = function()
            window_shake_x = value_1
            window_shake_y = value_2
        end
    }
end
...
function onUpdate()
    ...
    window_shake_temp_x = math.random(-window_shake_x, window_shake_x)
    window_shake_temp_y = math.random(-window_shake_y, window_shake_y)
